...
(function() {
  var CompositeToken, LoopToken, MoveToken, RandomMoveToken, ResetToken, Segment, SetLengthToken, StateManager, Token, Vector, drawLine, fragShaderSource, getInnerSegments, getSegments, getToken, get_shader, gl, initBuffer, initBuffers, initGL, initScene, initShaders, peel, peelable, shaderProgram, stateManager, unbindBuffers, vtxShaderSource,
  ...
  peel = function(codeString) {
    return codeString.slice(0, codeString.length);
  };
  ...
  $(document).ready(function() {
    ...
    return $('#prompt').keypress(function(event) {
      ...
      if (event.keyCode === 13) {
        ...
        segmentStrings = _.map(getSegments(promptText), function(x) {
          return x.trim();
        });
        initScene();
        stateManager.reset();
